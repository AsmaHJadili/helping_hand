...
import 'package:helping_hand/games/game4/situationC4.dart';

class SituationC3 extends StatefulWidget {
  const SituationC3({super.key});

  @override
  State<SituationC3> createState() => _SituationC3State();
}

class _SituationC3State extends State<SituationC3> {
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  _buildEmotionOption('أطلب منهم الانضمام للعب معهم'),
                ],
              ),
    ...
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const SituationC4()),
          );
        },
        style: ElevatedButton.styleFrom(
          backgroundColor: const Color(0xFFA2E4B1),
