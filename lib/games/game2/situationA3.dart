...
import 'package:helping_hand/games/game2/situationA4.dart';
import 'package:helping_hand/games/game3/situationB1.dart';
import 'package:helping_hand/games/game4/situationC1.dart';

class SituationA3 extends StatefulWidget {
  const SituationA3({super.key});

  @override
  State<SituationA3> createState() => _SituationA3State();
}

class _SituationA3State extends State<SituationA3> {
          ...
          child: Column(
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: Image.asset(
                  './assets/images/games-images/game2/image23.jpg',
              ...
              Column(
                children: [
                  _buildEmotionOption('اخذ المحفظة وأضعها في كنزي الشخصي'),
                  const SizedBox(height: 15), // مسافة بين الأزرار
                  _buildEmotionOption('اخذ المحفظة لبعض الوقت'),
                  const SizedBox(height: 15),
                  _buildEmotionOption('أعطيها لشخص مسؤول ليعيدها لصاحبها'),
                ],
              ),
