...
import 'package:helping_hand/games/game2/situationA3.dart';
import 'package:helping_hand/games/game3/situationB1.dart';
import 'package:helping_hand/games/game4/situationC1.dart';

class SituationA2 extends StatefulWidget {
  const SituationA2({super.key});

  @override
  State<SituationA2> createState() => _SituationA2State();
}

class _SituationA2State extends State<SituationA2> {
          ...
          child: Column(
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: Image.asset(
                  './assets/images/games-images/game2/image22.jpg',
              ...
              Column(
                children: [
                  _buildEmotionOption('أكذب ,وأقول اني قمت به ونسيته بالمدرسة'),
                  const SizedBox(height: 15), // مسافة بين الأزرار
                  _buildEmotionOption('أخفي,لا أجيب وأغير الموضوع'),
                  const SizedBox(height: 15),
                  _buildEmotionOption('أصدق,أعتذر وأقر اني سأفعله الان'),
                ],
              ),
