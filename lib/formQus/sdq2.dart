...
import 'package:helping_hand/formQus/sdq3.dart';
...
class SDQ2 extends StatefulWidget {
  const SDQ2({super.key});

  @override
  State<SDQ2> createState() => _SDQFormScreenState();
}

class _SDQFormScreenState extends State<SDQ2> {
  ...
  final List<Question> _questions = [
    Question(id: 9, text: 'يساعد الآخرين إذا حدث لأحدهم مكروه '),
    Question(id: 10, text: 'يتململ أو يتلوى  باستمرار أثناء الجلوس'),
    Question(id: 11, text: 'لديه على الأقل صديق واحد جيد'),
    Question(id: 12, text: 'كثيراً ما يتعارك مع الآخرين من نفس\n سنه أو يستأسد عليهم'),
    Question(id: 13, text: 'كثيراً ما يكون غير سعيد أو حزين \n أو يبكي بسهولة'),
    Question(id: 14, text: 'في الغالب محبوب ممن هم في سنه'),
    Question(id: 15, text: 'يتشتت انتباهه بسرعة وقليل التركيز'),
    Question(id: 16, text: 'عصبي أو متشبث بالآخرين في المواقف\n الجديدة, يفقد ثقته بنفسه بسهولة'),
    Question(id: 17, text: 'لطيف مع من هم أصغر منه'),
  ];
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (_areAllQuestionsAnswered()) {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const SDQ3()));
                    } else {
                       ScaffoldMessenger.of(context).showSnackBar(
