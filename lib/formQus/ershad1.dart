...
class SDQIntroScreen extends StatefulWidget {
  const SDQIntroScreen({super.key});

  @override
  State<SDQIntroScreen> createState() => _SDQIntroScreenState();
}

class _SDQIntroScreenState extends State<SDQIntroScreen> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _buildStepText('أجب بدقة عن كل سؤال'),
                    _buildStepText('أجب أنت وليس طفلك'),
                    _buildStepText('أحد الوالدين يجيب وليس كليهما'),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('جارٍ بدء استبيان SDQ...')),
                          );
                          Navigator.push(context, MaterialPageRoute(builder: (context) => const SDQ1()));
                        },
